...
#set_property PACKAGE_PIN T8 [get_ports {videoON}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {videoON}]
...
#set_property PACKAGE_PIN F15 [get_ports top]						
...
#set_property PACKAGE_PIN V10 [get_ports bottom]						
	#set_property IOSTANDARD LVCMOS33 [get_ports bottom]
