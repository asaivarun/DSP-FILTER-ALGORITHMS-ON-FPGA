...
HD_PWD='C:/Users/admin/Desktop/bhavesh/codegen/noise_cancel/fil/noise_cancel_fixpt_fil/fpgaproj/noise_cancel_fixpt_fil.runs/jtag_mac_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jtag_mac_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source jtag_mac_fifo.tcl
