...
HD_PWD='C:/Users/admin/Desktop/bhavesh/codegen/noise_cancel/fil/noise_cancel_fixpt_fil/fpgaproj/noise_cancel_fixpt_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log noise_cancel_fixpt_fil.vdi -applog -m64 -messageDb vivado.pb -mode batch -source noise_cancel_fixpt_fil.tcl -notrace
