...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%#codegen
function [ e,W,bhat ] = noise_cancel_fixpt( s,n,e_1,W_1,bhat_1)
...
fm = get_fimath();
W = fi(W_1, 1, 14, 15, fm);
bhat = fi(bhat_1, 1, 14, 17, fm);
e = fi(e_1, 1, 14, 17, fm);

itno=fi(length(s)-10, 0, 7, 0, fm);
bhat=fi(zeros(1,fi_toint(itno)), 1, 14, 17, fm);
W=fi(zeros(1,size(bhat,fi(1, 0, 1, 0, fm))), 1, 14, 15, fm);
e=fi(zeros(1,fi_toint(itno)), 1, 14, 17, fm);
